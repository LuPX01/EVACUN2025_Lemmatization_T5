...
training_args = TrainingArguments(
    output_dir="/Volumes/T7 Data/EVACUN_trained_model/byt5_small-ALL-lemma-v4",
    ...
    num_train_epochs=2,
    weight_decay=0.01,
    logging_dir='/Volumes/T7 Data/EVACUN_trained_model/byt5_small-ALL-lemma-v4/logs',
    logging_steps=100,
    save_total_limit=3,
    save_steps=1000,
    eval_steps=1000,
...
model.save_pretrained("../../byt5_small-ALL-lemma-v4")
tokenizer.save_pretrained("../../byt5_small-ALL-lemma-v4")
