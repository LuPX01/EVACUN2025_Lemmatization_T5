...
# 加载微调后的模型和分词器
tokenizer = ByT5Tokenizer.from_pretrained("../../byt5_small-ALL-lemma-v4.1")
model = T5ForConditionalGeneration.from_pretrained("../../byt5_small-ALL-lemma-v4.1")

# 将模型切换为评估模式
model.eval()

# 读取数据集 Excel 文件
data_file_path = "../../data/EBL_lemmatization_val_data_final_SIMPLE.xlsx"
...
# 将预测结果和指标写入 Excel 文件
output_file_path = "../../results/ByT5v4.1_ALL_predictions_with_metrics_forEBLfinalSIMPLE.xlsx"
