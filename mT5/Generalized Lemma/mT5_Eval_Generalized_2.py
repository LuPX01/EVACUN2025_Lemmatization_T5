...
# 加载微调后的模型和分词器
tokenizer = T5Tokenizer.from_pretrained("../../mt5_small-ALL-lemma-v1")
model = MT5ForConditionalGeneration.from_pretrained("../../mt5_small-ALL-lemma-v1")
...
# 将预测结果和指标写入 Excel 文件
output_file_path = "../../results/mT5v1_ALL_predictions_with_metrics_forEBLfinalSIMPLE.xlsx"
