...
training_args = TrainingArguments(
    output_dir="/Volumes/T7 Data/EVACUN_trained_model/mt5_small-ALL-lemma-v2",
    ...
    num_train_epochs=10,
    weight_decay=0.01,
    logging_dir='/Volumes/T7 Data/EVACUN_trained_model/mt5_small-ALL-lemma-v2/logs',
    logging_steps=100,
    save_total_limit=3,
    save_steps=1000,
    eval_steps=1000,
...
model.save_pretrained("../../mt5_small-ALL-lemma-v2")
tokenizer.save_pretrained("../../mt5_small-ALL-lemma-v2")
